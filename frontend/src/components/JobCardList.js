...
    setLoading(true);
    try {
      // --- AFFECTED PART: Updated API URL for GET ---
      const res = await axios.get(`${API_BASE_URL}/api/jobcards?page=${page}&limit=10&search=${term}`);
      // --------------------------------------------
...
      buttons: ['Yes', 'No'],
      onConfirm: async () => {
        // --- AFFECTED PART: Updated API URL for DELETE ---
        await axios.delete(`${API_BASE_URL}/api/jobcards/${id}`);
        // -----------------------------------------------
