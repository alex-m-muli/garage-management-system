...
// This variable is set in Netlify and contains your Render URL (e.g., https://garage-management-system-jlj0.onrender.com)
...
    try {
      // --- CHANGED: Use API_BASE_URL for axios call ---
      const res = await axios.get(`${API_BASE_URL}/api/backup/create`);
      const backupName = res.data.folder;

      // --- CHANGED: Use API_BASE_URL for fetch call ---
      const zipUrl = `${API_BASE_URL}/backups/${backupName}.zip`;
...
    try {
      // --- CHANGED: Use API_BASE_URL for axios call ---
      await axios.post(`${API_BASE_URL}/api/backup/restore`, { folderName });
